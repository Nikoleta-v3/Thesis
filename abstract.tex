...
heuristics and machine learning. %TODO does this sentence adds value
...
Furthermore, this thesis investigates best response strategies in the form of
...
networks are used to introduce a total of 24 new IPD strategies which were shown %TODO use variable instead of 24 once chapter 7 has been merged.
...
adapting to the environment and using longer memory when possible.
 % I know I am repeating myself in this paragraph. I thought it would be nice to have a summary sentence. what do you think?
