...
\begin{table}[!hbtp]
    ...
    \input{src/chapters/03/paper/Literature-Article/assets/preliminary_table}}
    \end{center}
...
\begin{figure}[!hbtp]
    \centering
    \includegraphics[width=.50\textwidth]{src/chapters/03/paper/Literature-Article/assets/images/forecasting.pdf}
...
\begin{figure}[!hbtp]
    \centering
    \includegraphics[width=.50\textwidth]{src/chapters/03/paper/Literature-Article/assets/images/papers_per_author.pdf}
...
\begin{figure}[!hbtp]
    \centering
    \includegraphics[width=.55\textwidth]{src/chapters/03/paper/Literature-Article/assets/images/collaborative_index.pdf}
...
\begin{figure}[!hbtp]
    \centering
    \includegraphics[width=.45\textwidth]{src/chapters/03/paper/Literature-Article/assets/images/coherence_values.pdf}
...
\begin{figure}[!hbtp]
    ...
    \begin{minipage}{.45\textwidth}
        \centering
        \includegraphics[width=.9\textwidth]{src/chapters/03/paper/Literature-Article/assets/images/topics_scatter_plot_6.pdf}
        \caption{Visualisation of LDA with \(n=6\) on 2 dimensions.}\label{fig:lda_visualisation_six}
    \end{minipage}\hfill
    \begin{minipage}{.45\textwidth}
        \centering
        \includegraphics[width=.9\textwidth]{src/chapters/03/paper/Literature-Article/assets/images/topics_scatter_plot_5.pdf}
...
\begin{table}[!hbtp]
    \begin{center}
    \resizebox{\textwidth}{!}{
    \input{src/chapters/03/paper/Literature-Article/assets/documents_of_topic}}
    \end{center}
...
\begin{figure}[!hbtp]
    \centering
    \includegraphics[width=\textwidth]{src/chapters/03/paper/Literature-Article/assets/images/papers_per_topic_over_time.pdf}
...
\begin{table}[!hbtp]
    \begin{center}
    \resizebox{\textwidth}{!}{
    \input{src/chapters/03/paper/Literature-Article/assets/topics_per_year_table}}
    \end{center}
...
\begin{figure}[!hbtp]
    \centering
    \includegraphics[width=.75\textwidth]{src/chapters/03/paper/Literature-Article/assets/images/contribution_over_time.pdf}
...
\begin{figure}[!hbtp]\vspace{-2cm}
    \begin{subfigure}{.95\textwidth}\centering
        \includegraphics[width=.5\textwidth]{src/chapters/03/paper/Literature-Article/assets/images/pd_network.pdf}
        \caption{\(G\) the co-authorship network for the IPD.}
    \end{subfigure}\hfill
    \begin{subfigure}{.95\textwidth}\centering
        \includegraphics[width=.5\textwidth]{src/chapters/03/paper/Literature-Article/assets/images/pd_network_cluster.pdf}
...
\begin{table}[!hbtp]
    \centering
    \resizebox{\textwidth}{!}{
    \input{src/chapters/03/paper/Literature-Article/assets/network_comparison.tex}}
...
\begin{table}[!hbtp]
    \centering
    \resizebox{\textwidth}{!}{
    \input{src/chapters/03/paper/Literature-Article/assets/other_topics_network_comparison.tex}}
...
\begin{table}[!hbtp]
    \centering
    \resizebox{\textwidth}{!}{
    \input{src/chapters/03/paper/Literature-Article/assets/topic_network_comparison.tex}}
...
\begin{table}[!hbtp]
    \begin{center}
    \resizebox{.9\textwidth}{!}{\input{src/chapters/03/paper/Literature-Article/assets/centralities_pd_graph.tex}}
\end{center}
...
\begin{table}[!hbtp]
    \begin{center}
    \resizebox{.9\textwidth}{!}{\input{src/chapters/03/paper/Literature-Article/assets/betweeness_topics_graphs.tex}}
\end{center}
...
\begin{table}[!hbtp]
    \begin{center}
    \resizebox{.9\textwidth}{!}{\input{src/chapters/03/paper/Literature-Article/assets/closeness_topics_graphs.tex}}
\end{center}
...
\begin{table}[!hbtp]
    ...
    \input{src/chapters/03/paper/Literature-Article/assets/cumulative_graphs_table.tex}}
\end{table}
...
\begin{table}[!hbtp]
    \centering
    \resizebox{.8\textwidth}{!}{
    \input{src/chapters/03/paper/Literature-Article/assets/cumulative_clusters_table.tex}}
\end{table}
...
\begin{figure}[!hbtp]
    \centering
    \includegraphics[width=.8\textwidth]{src/chapters/03/paper/Literature-Article/assets/images/pd_betweeness_centralities.pdf}
...
\begin{figure}[!hbtp]
    \centering
    \includegraphics[width=.8\textwidth]{src/chapters/03/paper/Literature-Article/assets/images/pd_closeness_centralities.pdf}
...
\begin{figure}[!hbtp]
    \centering
    \includegraphics[width=\textwidth]{src/chapters/03/paper/Literature-Article/assets/images/topics_betweeness_distributions.pdf}
...
\begin{figure}[!hbtp]
    \centering
    \includegraphics[width=\textwidth]{src/chapters/03/paper/Literature-Article/assets/images/topics_closeness_distributions.pdf}
