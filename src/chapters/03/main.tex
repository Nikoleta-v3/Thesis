...
class Arxiv(Api):
    ...
    def get_root(response):
        ...
        return root
\end{minted}
\caption{Class Arxiv is implemented in Arcas. It includes the code necassaty for Arcas
to quert the API of arXiv.}\label{fig:arcas_arxiv}
\end{figure}
...
\end{minted}
\caption{Class Ieee is implemented in Arcas. It includes the code necassaty for Arcas
to quert the API of IEEE.}\label{fig:arcas_ieee}
\end{figure}
