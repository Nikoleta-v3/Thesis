...
\begin{center}
    ...
    Associated data set: \cite{auction_data_2018}, \cite{anarchy_data_2018}, \cite{pd_data_2018}\\
...
Consider the example of retrieving a single article with the word `Prisoners
...
class Arxiv(Api):
    ...
    def get_root(response):
        ...
        return root
\end{minted}
\caption{Class \mintinline{python}{Arxiv} is implemented in Arcas. It includes the code necessary for Arcas
...
\end{minted}
\caption{Class \mintinline{python}{Ieee} is implemented in Arcas. It includes the code necessary for Arcas
...
\end{sourcepy}
\caption[Unit tests for class \mintinline{python}{Arxiv}.]{Unit tests for class \mintinline{python}{Arxiv}. Tests the functionality of the method \mintinline{python}{to_dataframe}.}\label{fig:test_arxiv}
\end{figure}
...
\end{sourcepy}
\caption{Unit tests for class \mintinline{python}{Ieee}.}\label{fig:test_ieee}
\end{figure}
