...
open source package Arcas which was used for the data collection. The
Chapter includes snippets of the source code for the implemented APIs and
their respective unit tests. Furthermore, it includes examples of usage of
Arcas.
...
'description': "Players with insider information can help increase ... in the minority game",
...
\begin{itemize}
    ...
    structures.
    \item The publication assigned to Topic E are on modelling problems
