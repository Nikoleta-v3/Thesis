\chapter{A literature review of the Prisoner's Dilemma.}\label{chapter:literature_review}
...
sought to understand several of these conditions was the mathematical
...
submitted by James W. Friedman. The name \Grudger was given to the strategy
...
opponent will never do better than them. Press and Dyson suggested that the ZDs
...
strategies. Memory-one strategies and their limitations are also studied in
this thesis, more specifically in Chapter~\ref{chapter:memory_one}.

This section of the literature review covered the original computer tournaments of
Axelrod, the early success of \TitForTat in these tournaments and large
number of IPD strategies. Though \TitForTat was
...
the basic reciprocal approaches were presented, followed by memory-one
...
established by the biologist J. Maynard Smith~\cite{Smith1974,
...
D. Hamilton the Newcomb-Cleveland prize of the American Association for the
Advancement of Science in 1981. In~\cite{Axelrod1981} pairs of individuals from a
...
considered by Zhang and coworkers~\cite{Perc2011}. Graphs with a probability of rewiring 
connections were considered, and the rewire could be with any given node in the
graphs and not just with immediate neighbours. Zhang et al concluded that
...
This section considered papers on evolutionary dynamics and mechanisms that
...
would take over the population in a Moran process. The strategies evolved an ability
...
Several projects, however, are open source and available. Two educational
