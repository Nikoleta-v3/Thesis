...
brief literature review on the research this thesis is building upon. This
...
Axelrod asked researchers to design a strategy with the purpose of wining an IPD
tournament. A
...
move in the first round, the opening move a transient effect and has no affect
on the game in long run~\cite{sigmund2010calculus}. Consequently, reactive strategies
can be described as \(p \in R^2\) and memory-one strategies as \(p \in R^2\).
