...
This Chapter provides a systematic literature on the Prisoner's Dilemma.
It partitions the literature in five different sections each reviewing a
different aspect of research. The Chapter is structured as follows:

\begin{itemize}
    \item section~\ref{section:origin} presents the origin of the Prisoner's
    Dilemma and reviews the early publications in the field and the use of
    ...
    \item section~\ref{section:evolutionary_dynamics} review research on evolutionary
    dynamics.
    ...
    \item section~\ref{section:software} reports several pieces of software
    used for simulating the PD game.
\end{itemize}

The aim of this Chapter is to provide a concrete summary of the existing
literature on the PD and contribute to research question 1.
...
%TODO add discussion for intelligent design strategies. Define them
...
% Axelrod asked researchers to design a strategy with the purpose of
% wining an IPD tournament.

% This section covers Axelrod's original
...
%TODO more on results on the memory one strategies and refer to Chapter 5.
...
strategies were introduced called \textit{Zero-determinant}
...
generous set of ZDs, the~\textit{Generous ZD}, were shown to outperform the more
...
%TODO convince myself that I am happy with this section
...
Eq~(\ref{eq:donation_game})), it was shown that cooperation will
...
%TODO more details on the define training process and refer to chapter 6 & 7.
...
% Todo discuss that part a big part of this thesis
...
% Coclusion of the five sections, how the next chaoter will complete this and
% how the results of the literature feed into the thesis