...
\begin{figure}[!hbtp]
    \begin{subfigure}{.45\textwidth}\centering
        \includestandalone[width=.27\textheight]{src/chapters/02/tex/gambler_diagram}
        % \caption{Tit for Tat as a finite state machine with 1 state.}\label{fig:representation_a}
    \end{subfigure}\hspace{1cm}
    \begin{subfigure}{.45\textwidth}\centering
        \includestandalone[width=.27\textheight]{src/chapters/02/tex/gambler_diagram_choice}
