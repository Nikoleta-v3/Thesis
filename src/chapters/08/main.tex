...
\begin{enumerate}
    ...
    \item A data set of 45686 Iterated Prisoner's Dilemma tournaments' results~\cite{Glynatsi2019_meta, Glynatsi2019_meta_raw_data} %TODO include raw data citation, check citation is still data.
