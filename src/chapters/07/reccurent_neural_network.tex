...
\begin{document}
    \begin{tikzpicture}
        ...
        \node[above=1cm of layer1,output, font=\boldmath] (o1) {$y_1$};
        ...
        \node[above=1cm of layer2, output, font=\boldmath] (o2) {$y_2$};
        ...
        \node[above=1cm of layer4, output, font=\boldmath] (o4) {$y_t$};
