...
LSTM unique architecture allows them to be trained with the back propagation
algorithm. The networks were chosen to train a variety of IPD strategies because
of their ability to use a history of actions to make a prediction.
The training of
