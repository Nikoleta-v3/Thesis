...
introducing the usage of the Iterated Prisoner's Dilemma and computer modeling
...
symbol \mintinline{python}{>>>} is executed each time the document is pushed on GitHub.
