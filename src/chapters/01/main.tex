...
\begin{table}[htbp]
    ...
    \begin{tabular}{clcc}
        ...
        \cite{Glynatsi_2020_sensei} & \cite{Glynatsi2020_sequences, Glynatsi_2020_lstm_weights} \\
        \bottomrule
    \end{tabular}}
...
Throughout the thesis, parts of the source code and examples of its usage are
