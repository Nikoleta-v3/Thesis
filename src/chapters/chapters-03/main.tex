...
\begin{table}[!hbtp]
    ...
    \input{src/chapters/chapters-03/paper/Literature-Article/assets/preliminary_table}}
    \end{center}
...
\begin{table}[!hbtp]
    \begin{center}
    \resizebox{\textwidth}{!}{
    \input{src/chapters/chapters-03/paper/Literature-Article/assets/documents_of_topic}}
    \end{center}
...
\begin{table}[!hbtp]
    \begin{center}
    \resizebox{\textwidth}{!}{
    \input{src/chapters/chapters-03/paper/Literature-Article/assets/topics_per_year_table}}
    \end{center}
...
\begin{table}[!hbtp]
    \centering
    \resizebox{\textwidth}{!}{
    \input{src/chapters/chapters-03/paper/Literature-Article/assets/network_comparison.tex}}
...
\begin{table}[!hbtp]
    \centering
    \resizebox{\textwidth}{!}{
    \input{src/chapters/chapters-03/paper/Literature-Article/assets/other_topics_network_comparison.tex}}
...
\begin{table}[!hbtp]
    \centering
    \resizebox{\textwidth}{!}{
    \input{src/chapters/chapters-03/paper/Literature-Article/assets/topic_network_comparison.tex}}
...
\begin{table}[!hbtp]
    \begin{center}
    \resizebox{.9\textwidth}{!}{\input{src/chapters/chapters-03/paper/Literature-Article/assets/centralities_pd_graph.tex}}
\end{center}
...
\begin{table}[!hbtp]
    \begin{center}
    \resizebox{.9\textwidth}{!}{\input{src/chapters/chapters-03/paper/Literature-Article/assets/betweeness_topics_graphs.tex}}
\end{center}
...
\begin{table}[!hbtp]
    \begin{center}
    \resizebox{.9\textwidth}{!}{\input{src/chapters/chapters-03/paper/Literature-Article/assets/closeness_topics_graphs.tex}}
\end{center}
...
\begin{table}[!hbtp]
    ...
    \input{src/chapters/chapters-03/paper/Literature-Article/assets/cumulative_graphs_table.tex}}
\end{table}
...
\begin{table}[!hbtp]
    \centering
    \resizebox{.8\textwidth}{!}{
    \input{src/chapters/chapters-03/paper/Literature-Article/assets/cumulative_clusters_table.tex}}
\end{table}
