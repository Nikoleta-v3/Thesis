...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.6\textwidth]{src/chapters/04/paper/axlml/images/tit_for_tat_r_distributions.pdf}
...
\begin{table}[!htbp]
    ...
    \resizebox{.9\textwidth}{!}{
        \input{src/chapters/04/paper/axlml/paper/top_perfomances.tex}
    }
\end{center}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.7\textwidth]{src/chapters/04/paper/axlml/images/performance_standard.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.7\textwidth]{src/chapters/04/paper/axlml/images/performance_noise.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{src/chapters/04/paper/axlml/images/noise_effect.pdf}
...
\begin{table}[!htbp]
    ...
    \input{src/chapters/04/paper/axlml/paper/performance_noise_subset_table.tex}}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=.7\textwidth]{src/chapters/04/paper/axlml/images/performance_probend.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=\textwidth]{src/chapters/04/paper/axlml/images/folk_theorem.pdf}
...
\begin{table}[!htbp]
    \centering
    \resizebox{.30\textwidth}{!}{
    \input{src/chapters/04/paper/axlml/paper/performance_probend_subset_table.tex}}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.7\textwidth]{src/chapters/04/paper/axlml/images/performance_probend_noise.pdf}
...
\begin{table}[!htbp]
    \centering
    \resizebox{.30\textwidth}{!}{
    \input{src/chapters/04/paper/axlml/paper/performance_probend_noise_subset_table.tex}}
...
\begin{table}[!htbp]
    ...
    \input{src/chapters/04/paper/axlml/paper/performance_merged_table.tex}}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.7\textwidth]{src/chapters/04/paper/axlml/images/performance_merged.pdf}
...
\begin{table}[!htbp]
    \begin{center}
    \resizebox{.9\textwidth}{!}{
        \input{src/chapters/04/paper/axlml/paper/correlations_table.tex}
    }
\end{center}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.65\textwidth]{src/chapters/04/paper/axlml/images/rates_of_winners_in_standard_tournaments.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.65\textwidth]{src/chapters/04/paper/axlml/images/c_r_winners_tournaments.pdf}
...
\begin{figure}[!htbp]
    \begin{subfigure}[t]{0.5\textwidth}
        \begin{center}
            \includegraphics[width=.75\linewidth]{src/chapters/04/paper/axlml/new_output/standard/_feature_importance_bar_plot_cluster_on_0_05.pdf}
        \end{center}
        \caption{Importance of features for clusters on 5\% performance.}
    \end{subfigure}\hfill
    \begin{subfigure}[t]{0.5\textwidth}
        \begin{center}
            \includegraphics[width=.75\linewidth]{src/chapters/04/paper/axlml/new_output/standard/_feature_importance_bar_plot_cluster_on_0_25.pdf}
        \end{center}
        \caption{Importance of features for clusters on 25\% performance.}
    \end{subfigure}
    \begin{subfigure}[t]{0.5\textwidth}
        \begin{center}
            \includegraphics[width=.75\linewidth]{src/chapters/04/paper/axlml/new_output/standard/_feature_importance_bar_plot_cluster_on_0_5.pdf}
        \end{center}
        \caption{Importance of features for clusters on 50\% performance.}
    \end{subfigure}\hfill
    \begin{subfigure}[t]{0.5\textwidth}
        \begin{center}
            \includegraphics[width=.75\linewidth]{src/chapters/04/paper/axlml/k_means_output/standard/_feature_importance_bar_plot.pdf}
        \end{center}
...
\begin{figure}[!htbp]
    \begin{subfigure}{0.5\textwidth}
        \begin{center}
            \includegraphics[width=.75\linewidth]{src/chapters/04/paper/axlml/new_output/noise/_feature_importance_bar_plot_cluster_on_0_05.pdf}
        \end{center}
        \caption{Importance of features for clusters on 5\% performance.}
    \end{subfigure}\hfill
    \begin{subfigure}{0.5\textwidth}
        \begin{center}
            \includegraphics[width=.75\linewidth]{src/chapters/04/paper/axlml/new_output/noise/_feature_importance_bar_plot_cluster_on_0_25.pdf}
        \end{center}
        \caption{Importance of features for clusters on 25\% performance.}
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
        \begin{center}
            \includegraphics[width=.75\linewidth]{src/chapters/04/paper/axlml/new_output/noise/_feature_importance_bar_plot_cluster_on_0_5.pdf}
        \end{center}
        \caption{Importance of features for clusters on 50\% performance.}
    \end{subfigure}\hfill
    \begin{subfigure}{0.5\textwidth}
        \begin{center}
            \includegraphics[width=.75\linewidth]{src/chapters/04/paper/axlml/k_means_output/noise/_feature_importance_bar_plot.pdf}
        \end{center}
        \caption{Importance of features for clusters based on \(k\)means algorithm.}
    \end{subfigure}
...
\begin{figure}[!htbp]
    \begin{subfigure}[t]{0.5\textwidth}
        \begin{center}
            \includegraphics[width=.75\linewidth]{src/chapters/04/paper/axlml/new_output/probend/_feature_importance_bar_plot_cluster_on_0_05.pdf}
        \end{center}
        \caption{Importance of features for clusters on 5\% performance.}
    \end{subfigure}
    \begin{subfigure}[t]{0.5\textwidth}
        \begin{center}
            \includegraphics[width=.75\linewidth]{src/chapters/04/paper/axlml/new_output/probend/_feature_importance_bar_plot_cluster_on_0_25.pdf}
        \end{center}
        \caption{Importance of features for clusters on 25\% performance.}
    \end{subfigure}
    \begin{subfigure}[t]{0.5\textwidth}
        \begin{center}
            \includegraphics[width=.75\linewidth]{src/chapters/04/paper/axlml/new_output/probend/_feature_importance_bar_plot_cluster_on_0_5.pdf}
        \end{center}
        \caption{Importance of features for clusters on 50\% performance.}
    \end{subfigure}
    \begin{subfigure}[t]{0.5\textwidth}
        \begin{center}
            \includegraphics[width=.75\linewidth]{src/chapters/04/paper/axlml/k_means_output/probend/_feature_importance_bar_plot.pdf}
        \end{center}
        \caption{Importance of features for clusters based on \(k\)means algorithm.}
    \end{subfigure}
...
\begin{figure}[!htbp]
    \begin{subfigure}[t]{0.5\textwidth}
        \begin{center}
            \includegraphics[width=.75\linewidth]{src/chapters/04/paper/axlml/new_output/probend_noise/_feature_importance_bar_plot_cluster_on_0_05.pdf}
        \end{center}
        \caption{Importance of features for clusters on 5\% performance.}
    \end{subfigure}
    \begin{subfigure}[t]{0.5\textwidth}
        \begin{center}
            \includegraphics[width=.75\linewidth]{src/chapters/04/paper/axlml/new_output/probend_noise/_feature_importance_bar_plot_cluster_on_0_25.pdf}
        \end{center}
        \caption{Importance of features for clusters on 25\% performance.}
    \end{subfigure}
    \begin{subfigure}[t]{0.5\textwidth}
        \begin{center}
            \includegraphics[width=.75\linewidth]{src/chapters/04/paper/axlml/new_output/probend_noise/_feature_importance_bar_plot_cluster_on_0_5.pdf}
        \end{center}
        \caption{Importance of features for clusters on 50\% performance.}
    \end{subfigure}
    \begin{subfigure}[t]{0.5\textwidth}
        \begin{center}
            \includegraphics[width=.75\linewidth]{src/chapters/04/paper/axlml/k_means_output/probend_noise/_feature_importance_bar_plot.pdf}
        \end{center}
        \caption{Importance of features for clusters based on \(k\)means algorithm.}
    \end{subfigure}
...
\begin{figure}[!htbp]
    \begin{subfigure}[t]{0.5\textwidth}
        \begin{center}
            \includegraphics[width=.75\linewidth]{src/chapters/04/paper/axlml/new_output/merged/_feature_importance_bar_plot_cluster_on_0_05.pdf}
        \end{center}
        \caption{Importance of features for clusters on 5\% performance.}
    \end{subfigure}
    \begin{subfigure}[t]{0.5\textwidth}
        \begin{center}
            \includegraphics[width=.75\linewidth]{src/chapters/04/paper/axlml/new_output/merged/_feature_importance_bar_plot_cluster_on_0_25.pdf}
        \end{center}
        \caption{Importance of features for clusters on 25\% performance.}
    \end{subfigure}
    \begin{subfigure}[t]{0.5\textwidth}
        \begin{center}
            \includegraphics[width=.75\linewidth]{src/chapters/04/paper/axlml/new_output/merged/_feature_importance_bar_plot_cluster_on_0_5.pdf}
        \end{center}
        \caption{Importance of features for clusters on 50\% performance.}
    \end{subfigure}
    \begin{subfigure}[t]{0.5\textwidth}
        \begin{center}
            \includegraphics[width=.75\linewidth]{src/chapters/04/paper/axlml/k_means_output/merged/_feature_importance_bar_plot.pdf}
        \end{center}
        \caption{Importance of features for clusters based on \(k\)means algorithm.}
    \end{subfigure}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.5\textwidth]{src/chapters/04/paper/axlml/images/compared_to_mean_median_standard.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.5\textwidth]{src/chapters/04/paper/axlml/images/compared_to_mean_median_noisy.pdf}
    \caption{Distributions of \(C_r / C_{\text{median}}\)
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.5\textwidth]{src/chapters/04/paper/axlml/images/compared_to_mean_median_probend.pdf}
    \caption{Distributions of \(C_r / C_{\text{median}}\)
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.5\textwidth]{src/chapters/04/paper/axlml/images/compared_to_mean_median_probend_noisy.pdf}
    \caption{Distributions of \(C_r / C_{\text{median}}\)
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.5\textwidth]{src/chapters/04/paper/axlml/images/compared_to_mean_median_overall.pdf}
    \caption{Distributions of \(C_r / C_{\text{median}}\)
...
\begin{multicols}{3}
	\begin{enumerate}
		\input{src/chapters/04/paper/axlml/paper/list_of_strategies.tex}
	\end{enumerate}
\end{multicols}
...
\begin{figure}[!htbp]
        \begin{center}
            \includegraphics[width=.75\linewidth]{src/chapters/04/paper/axlml/images/standard_correlation_plot.pdf}
        \end{center}
...
\begin{figure}[!htbp]
    \begin{center}
        \includegraphics[width=.75\linewidth]{src/chapters/04/paper/axlml/images/noise_correlation_plot.pdf}
    \end{center}
    \caption{Correlation coefficients of measures in Table~\ref{table:manual_measures}
...
\begin{figure}[!htbp]
    \begin{center}
        \includegraphics[width=.75\linewidth]{src/chapters/04/paper/axlml/images/probend_correlation_plot.pdf}
    \end{center}
    \caption{Correlation coefficients of measures in Table~\ref{table:manual_measures}
...
\begin{figure}[!htbp]
    \begin{center}
        \includegraphics[width=.75\linewidth]{src/chapters/04/paper/axlml/images/probend_noise_correlation_plot.pdf}
    \end{center}
    \caption{Correlation coefficients of measures in Table~\ref{table:manual_measures}
...
\begin{figure}[!htbp]
    \begin{center}
        \includegraphics[width=.75\linewidth]{src/chapters/04/paper/axlml/images/merged_correlation_plot.pdf}
    \end{center}
    \caption{Correlation coefficients of measures in Table~\ref{table:manual_measures}
    for data set}
\end{figure}