...
\begin{table}[!htbp]
    ...
    \resizebox{.9\textwidth}{!}{
        \input{src/chapters/chapters-04/paper/axlml/paper/top_perfomances.tex}
    }
\end{center}
...
\begin{table}[!htbp]
    ...
    \input{src/chapters/chapters-04/paper/axlml/paper/performance_noise_subset_table.tex}}
...
\begin{table}[!htbp]
    \centering
    \resizebox{.30\textwidth}{!}{
    \input{src/chapters/chapters-04/paper/axlml/paper/performance_probend_subset_table.tex}}
...
\begin{table}[!htbp]
    \centering
    \resizebox{.30\textwidth}{!}{
    \input{src/chapters/chapters-04/paper/axlml/paper/performance_probend_noise_subset_table.tex}}
...
\begin{table}[!htbp]
    ...
    \input{src/chapters/chapters-04/paper/axlml/paper/performance_merged_table.tex}}
...
\begin{table}[!htbp]
    \begin{center}
    \resizebox{.9\textwidth}{!}{
        \input{src/chapters/chapters-04/paper/axlml/paper/correlations_table.tex}
    }
\end{center}
...
\begin{multicols}{3}
	\begin{enumerate}
		\input{src/chapters/chapters-04/paper/axlml/paper/list_of_strategies.tex}
	\end{enumerate}
\end{multicols}
