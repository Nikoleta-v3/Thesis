...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.6\textwidth]{src/chapters/04/paper/meta-analysis-of-prisoners-dilemma-tournaments/images/tit_for_tat_r_distributions.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.7\textwidth]{src/chapters/04/paper/meta-analysis-of-prisoners-dilemma-tournaments/images/performance_standard.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.7\textwidth]{src/chapters/04/paper/meta-analysis-of-prisoners-dilemma-tournaments/images/performance_noise.pdf}
...
\begin{table}[!htbp]
    ...
    \input{src/chapters/04/paper/meta-analysis-of-prisoners-dilemma-tournaments/paper/performance_noise_subset_table.tex}}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=.7\textwidth]{src/chapters/04/paper/meta-analysis-of-prisoners-dilemma-tournaments/images/performance_probend.pdf}
...
\begin{table}[!htbp]
    \centering
    \resizebox{.30\textwidth}{!}{
    \input{src/chapters/04/paper/meta-analysis-of-prisoners-dilemma-tournaments/paper/performance_probend_subset_table.tex}}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.7\textwidth]{src/chapters/04/paper/meta-analysis-of-prisoners-dilemma-tournaments/images/performance_probend_noise.pdf}
...
\begin{table}[!htbp]
    \centering
    \resizebox{.30\textwidth}{!}{
    \input{src/chapters/04/paper/meta-analysis-of-prisoners-dilemma-tournaments/paper/performance_probend_noise_subset_table.tex}}
...
\begin{table}[!htbp]
    ...
    \input{src/chapters/04/paper/meta-analysis-of-prisoners-dilemma-tournaments/paper/performance_merged_table.tex}}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.7\textwidth]{src/chapters/04/paper/meta-analysis-of-prisoners-dilemma-tournaments/images/performance_merged.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.65\textwidth]{src/chapters/04/paper/meta-analysis-of-prisoners-dilemma-tournaments/images/rates_of_winners_in_standard_tournaments.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.65\textwidth]{src/chapters/04/paper/meta-analysis-of-prisoners-dilemma-tournaments/images/c_r_winners_tournaments.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.5\textwidth]{src/chapters/04/paper/meta-analysis-of-prisoners-dilemma-tournaments/images/compared_to_mean_median_standard.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.5\textwidth]{src/chapters/04/paper/meta-analysis-of-prisoners-dilemma-tournaments/images/compared_to_mean_median_noisy.pdf}
    \caption{Distributions of \(C_r / C_{\text{median}}\)
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.5\textwidth]{src/chapters/04/paper/meta-analysis-of-prisoners-dilemma-tournaments/images/compared_to_mean_median_probend.pdf}
    \caption{Distributions of \(C_r / C_{\text{median}}\)
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.5\textwidth]{src/chapters/04/paper/meta-analysis-of-prisoners-dilemma-tournaments/images/compared_to_mean_median_probend_noisy.pdf}
    \caption{Distributions of \(C_r / C_{\text{median}}\)
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.5\textwidth]{src/chapters/04/paper/meta-analysis-of-prisoners-dilemma-tournaments/images/compared_to_mean_median_overall.pdf}
    \caption{Distributions of \(C_r / C_{\text{median}}\)
...
\begin{multicols}{3}
	\begin{enumerate}
		\input{src/chapters/04/paper/meta-analysis-of-prisoners-dilemma-tournaments/paper/list_of_strategies.tex}
	\end{enumerate}
\end{multicols}
