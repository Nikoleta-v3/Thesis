...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.57\textwidth]{src/chapters/04/paper/meta-analysis-of-prisoners-dilemma-tournaments/images/rates_of_winners_in_standard_tournaments.pdf}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=.57\textwidth]{src/chapters/04/paper/meta-analysis-of-prisoners-dilemma-tournaments/images/c_r_winners_tournaments.pdf}
