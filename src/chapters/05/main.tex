...
\(\lambda=0.1\), direct substitution in Equation (\ref{eq:concave}) gives:
...
sets of best response memory-one strategies were estimated. Best response that
included and not self interactions. The behaviours of the best responses were
