...
\begin{table}[!htbp]
    ...
    \input{src/chapters/05/paper/Memory-size-in-the-prisoners-dilemma/tex/medians_tests.tex}}
...
% \input{src/chapters/05/paper/Memory-size-in-the-prisoners-dilemma/tex/proof_theorem_one}

% \subsection{Proof of Theorem~\ref{theorem:concavity}}\label{appendix:proof_theorem_three}
% \input{src/chapters/05/paper/Memory-size-in-the-prisoners-dilemma/tex/proof_theorem_three}

% \subsection{Proof of Lemma~\ref{lemma:memone_group_best_response}}\label{appendix:proof_lemma_four}
% \input{src/chapters/05/paper/Memory-size-in-the-prisoners-dilemma/tex/proof_lemma_four}

% \section{Further Examples}\label{section:appendix_b}

% \subsection{Example of non concavity for \(u(p)\) }\label{appendix:non_concave}
% \input{src/chapters/05/paper/Memory-size-in-the-prisoners-dilemma/tex/non_concave_example}