...
\begin{equation}\label{eq:transition_matrix}
    \input{src/chapters/chapters-05/paper/Memory-size-in-the-prisoners-dilemma/tex/m_matrix.tex}
\end{equation}
...
\begin{theorem}\label{theorem:quadratic_form_u}
    ...
    \boldmath\(
    Q = \input{src/chapters/chapters-05/paper/Memory-size-in-the-prisoners-dilemma/tex/q_numerator}\)},
    \end{equation}
    \begin{equation}\label{eq:q_bar_matrix}
    \resizebox{0.8\linewidth}{!}{\arraycolsep=2.5pt%
    \boldmath\(
    \bar{Q} =  \input{src/chapters/chapters-05/paper/Memory-size-in-the-prisoners-dilemma/tex/q_denominator}\)}.
    \end{equation}
    \end{center}
    ...
    \boldmath\(c = \input{src/chapters/chapters-05/paper/Memory-size-in-the-prisoners-dilemma/tex/c_numerator}\),}
    \end{equation}
    \begin{equation}\label{eq:q_matrix_denominator}
    \resizebox{0.3\linewidth}{!}{\arraycolsep=2.5pt%
    \boldmath\(\bar{c} = \input{src/chapters/chapters-05/paper/Memory-size-in-the-prisoners-dilemma/tex/c_denominator}\),
    }
    \end{equation}
    and the constant terms \(a, \bar{a}\) are defined as \(a = \input{src/chapters/chapters-05/paper/Memory-size-in-the-prisoners-dilemma/tex/numerator_constant}\) and
    \(\bar{a} = \input{src/chapters/chapters-05/paper/Memory-size-in-the-prisoners-dilemma/tex/denominator_constant}\).
\end{theorem}
...
\begin{figure}[!htbp]
    ...
    \begin{minipage}{0.21\textwidth}
        ...
        \resizebox{.85\columnwidth}{!}{%
            \input{src/chapters/chapters-05/paper/Memory-size-in-the-prisoners-dilemma/tex/sserror_table.tex}}
...
\begin{figure}[!htbp]
    ...
    \begin{minipage}{0.21\textwidth}
        ...
        \captionsetup{type=table}
        \resizebox{.85\columnwidth}{!}{%
            \input{src/chapters/chapters-05/paper/Memory-size-in-the-prisoners-dilemma/tex/evo_sserror_table.tex}}
...
\begin{table}[!htbp]
    ...
    \input{src/chapters/chapters-05/paper/Memory-size-in-the-prisoners-dilemma/tex/medians_tests.tex}}
...
\input{src/chapters/chapters-05/paper/Memory-size-in-the-prisoners-dilemma/tex/proof_theorem_one}

\subsection{Proof of Theorem~\ref{theorem:concavity}}\label{appendix:proof_theorem_three}
\input{src/chapters/chapters-05/paper/Memory-size-in-the-prisoners-dilemma/tex/proof_theorem_three}

\subsection{Proof of Lemma~\ref{lemma:memone_group_best_response}}\label{appendix:proof_lemma_four}
\input{src/chapters/chapters-05/paper/Memory-size-in-the-prisoners-dilemma/tex/proof_lemma_four}

\section{Further Examples}\label{section:appendix_b}

\subsection{Example of non concavity for \(u(p)\) }\label{appendix:non_concave}
\input{src/chapters/chapters-05/paper/Memory-size-in-the-prisoners-dilemma/tex/non_concave_example}