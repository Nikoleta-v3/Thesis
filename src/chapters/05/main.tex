...
A bespoke package has been developed to carrie out the calculations for this
...
\mintinline{python}{reactive_best_response.get_candinate_reactive_best_responses}
