...
\begin{center}
    ...
    The manuscript's abstract is the following:  % TODO Update when submitted/accepted
\end{center}
...
be out performed by longer memory strategies.  % TODO Update upon submission/acceptance
...
strategies and understand whether they behave in an extortionate way. Best
