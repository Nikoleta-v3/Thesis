...
\begin{equation}\label{eq:cross_product_coeffs}
    ...
    \boldmath\( 
    (p_1, p_2, p_3, p_4) \frac{1}{2} \input{src/chapters/chapters-05/paper/Memory-size-in-the-prisoners-dilemma/tex/q_numerator} \begin{pmatrix} 
    p_1 \\
    p_2 \\
    p_3 \\
    p_4 \end{pmatrix}
...
\begin{equation}\label{eq:linear_coeffs}
    ...
    \boldmath\(
    (p_1, p_2, p_3, p_4) \input{src/chapters/chapters-05/paper/Memory-size-in-the-prisoners-dilemma/tex/c_numerator}\)}
\end{equation}
...
\tiny\boldmath
\begin{align*}
    \frac{1}{2}p & \input{src/chapters/chapters-05/paper/Memory-size-in-the-prisoners-dilemma/tex/q_numerator} p^T +  \\
    & \input{src/chapters/chapters-05/paper/Memory-size-in-the-prisoners-dilemma/tex/q_numerator} p + q_{2} - 5 q_{4} - 1
\end{align*}
\endgroup
...
and \(a = \input{src/chapters/chapters-05/paper/Memory-size-in-the-prisoners-dilemma/tex/numerator_constant}\).
