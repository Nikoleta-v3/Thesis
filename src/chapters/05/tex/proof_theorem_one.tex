...
%     q_{4}) + p_{3} p_{4} (q_{1} q_{2} - q_{1} q_{4} - q_{2} + q_{4}) + p_{3}q_{4} (q_{2} - 1)}{\bar{v}} \right. + \\
%     & \left. \frac{-p_{4} q_{2} (q_{4} + 1) + p_{4} (q_{4} - 1)}{\bar{v}} \right., \\
%     & \left. \frac{- p_{1} p_{2} (q_{1} q_{4} - q_{3} q_{4}) - p_{1} p_{4} (- q_{1} q_{3} + q_{3} q_{4})
%     + p_{1} q_{1} q_{4} - p_{2} p_{4} (q_{1} q_{3} - q_{1} q_{4} - q_{3} + q_{4}) - p_{2} q_{4} (q_{3}  + 1)}{\bar{v}} \right. + \\
%     & \left. \frac{ - p_{4}q_{4} (q_{1} + q_{3}) - p_{4} (q_{3}
...
% \begin{equation*}
%     \begin{split}
%     \bar{v} = & \quad p_{1} p_{2} (q_{1} q_{2} - q_{1} q_{4} - q_{1} - q_{2} q_{3} + q_{3} q_{4} + q_{3}) - p_{1} p_{3} (q_{1} q_{3} -
%     q_{1} q_{4} - q_{2} q_{3} + q_{2} q_{4}) - \\
%     & \quad p_{1} p_{4} (q_{1} q_{2} - q_{1} q_{3} - q_{1} - q_{2} q_{4} + q_{3} q_{4} + q_{4}) - p_{1} q_{1} (q_{2} + q_{4} + 1) + \\
%     & \quad p_{2} p_{3} (- q_{1} q_{2} + q_{1} q_{3} + q_{2} q_{4} + q_{2} - q_{3} q_{4} - q_{3})
%      + p_{2} q_{2} (q_{3} - 1) - p_{2} q_{3} (q_{4} - 1) + \\
%     & \quad p_{2} p_{4} (- q_{1} q_{3} + q_{1} q_{4} + q_{2} q_{3} - q_{2} q_{4}) + p_{3} p_{4} (q_{1} q_{2} - q_{1} q_{4} - q_{2} q_{3} - q_{2} + q_{3} q_{4} + q_{4}) +\\
%     & \quad p_{3} q_{2} q_{1} ( - p_{3} - 1) + p_{2} (q_{4} + 1) +  p_{3} (q_{3} -
