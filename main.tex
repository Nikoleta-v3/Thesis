...
\newcommand{\uniquenumberofseeds}{\input{src/chapters/chapters-04/paper/axlml/paper/unique_number_of_seeds.tex}}
\newcommand{\numberofalltournaments}{\input{src/chapters/chapters-04/paper/axlml/paper/number_of_all_tournaments.tex}}
\newcommand{\numberofstrategies}{\input{src/chapters/chapters-04/paper/axlml/paper/unique_number_of_strategies.tex}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% ----------------------------------------------------------------------------
% The actual report
% ----------------------------------------------------------------------------
...
\input{src/chapters/chapters-04/main.tex}
\input{src/chapters/chapters-05/main.tex}
